      ...
      <ModalComponent forceRender title="Tạo sản phẩm" open={isModalOpen} onCancel={handleCancel} footer={null}>
        <Loading isLoading={isLoading}>
          ...
          >
            ...
            >
              <textarea style={{width: '70%'}} value={stateProduct.description} onChange={handleOnchange} name="description" />
            </Form.Item>
            <Form.Item
              label="Rating"
              name="rating"
        ...
        <Loading isLoading={isLoadingUpdate || isLoadingUpdated}>
          ...
          >
            ...
            <Form.Item
              ...
              rules={[{ required: true, message: 'Please input your count description!' }]}
            >
              <textarea style={{width: '70%'}} value={stateProductDetails.description} onChange={handleOnchangeDetails} name="description" />
            </Form.Item>
            <Form.Item
              label="Rating"
              name="rating"
