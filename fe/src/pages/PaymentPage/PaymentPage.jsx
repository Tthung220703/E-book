...
const PaymentPage = () => {
  ...
  useEffect(() => {
    if (isSuccess && dataAdd?.status === 'OK') {
      ...
      message.error()
      console.log(isSuccess, dataAdd?.status)
    } else if (isError) {
      const arrayOrdered = []
  ...
  const addPaypalScript = async () => {
    const result = order?.orderItemsSlected
    const  data  = await PaymentService.getConfig(result)
              ...
              <WrapperInfo>
                <div>
                  ...
                  <WrapperRadio onChange={handlePayment} value={payment}> 
                    ...
                    <Radio value="paypal"> Thanh toán tiền bằng zalo pay</Radio>
                  </WrapperRadio>
                </div>
              </WrapperInfo>
            </WrapperLeft>
